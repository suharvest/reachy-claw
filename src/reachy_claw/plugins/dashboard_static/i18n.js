...
(function () {
  const DICT = {
    en: {
      ...
      "panelLanguage.title": "Panel language",
      ...
      "conversationLanguage.title": "Exhibition Language",
      "conversationLanguage.zh": "Chinese scene",
      "conversationLanguage.en": "English scene",
      "conversationLanguage.hint": "ASR and replies use the same language.",
      "conversationLanguage.applying": "Switching language...",
      "conversationLanguage.status": "ASR: {asr} / TTS: {tts}",
      "toggle.vlm": "Visual Understanding (VLM)",
      "toggle.vlm.title": "Let replies use the camera image through VLM",
      "toggle.bargein": "Barge-in (Interrupts)",
      "toggle.bargein.title": "Toggle barge-in",
      "settingsDiag.title": "Runtime Status",
      "settingsDiag.motor": "Motor",
      "settingsDiag.motion": "Motion",
      "settingsDiag.speaking": "Speaking",
      "settingsDiag.mode": "Mode",
      "settingsDiag.on": "On",
      "settingsDiag.off": "Off",
      "settingsDiag.yes": "Yes",
      "settingsDiag.no": "No",
      "memory.title": "Memory",
    ...
    zh: {
      ...
      "lang.german": "德语",
      "lang.spanish": "西班牙语",
      "conversationLanguage.title": "展厅语言",
      "conversationLanguage.zh": "中文场景",
      "conversationLanguage.en": "英文场景",
      "conversationLanguage.hint": "识别语言和回复语言保持一致。",
      "conversationLanguage.applying": "正在切换语言…",
      "conversationLanguage.status": "识别：{asr} / 回复：{tts}",
      "toggle.vlm": "视觉理解 (VLM)",
      "toggle.vlm.title": "让回答通过 VLM 参考摄像头画面",
      "toggle.bargein": "插话打断",
      "toggle.bargein.title": "开启/关闭插话打断",
      "settingsDiag.title": "运行状态",
      "settingsDiag.motor": "电机",
      "settingsDiag.motion": "动作",
      "settingsDiag.speaking": "正在说话",
      "settingsDiag.mode": "模式",
      "settingsDiag.on": "开启",
      "settingsDiag.off": "关闭",
      "settingsDiag.yes": "是",
      "settingsDiag.no": "否",
