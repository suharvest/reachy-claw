...
(function () {
  const DICT = {
    en: {
      ...
      // ── Details tab ──
      "speechProvider.title": "Speech Model Mode",
      "speechProvider.mode": "Mode",
      "speechProvider.local": "Local",
      "speechProvider.online": "Online Qwen",
      "speechProvider.apiKey": "DashScope API Key",
      "speechProvider.url": "Qwen Realtime URL",
      "speechProvider.model": "Realtime Model",
      "speechProvider.voice": "Voice",
      "speechProvider.compatUrl": "Vision API URL",
      "speechProvider.visionModel": "Vision Model",
      "speechProvider.apply": "Save Speech Mode",
      "speechProvider.current": "Current: {mode}",
      "speechProvider.keySaved": "API key saved",
      "speechProvider.keyMissing": "API key missing",
      "speechProvider.restartRequired": "restart speech service to apply",
      "speechProvider.saved": "Speech mode saved",
      "speechProvider.loadFailed": "Failed to load speech mode",
      "speechProvider.saveFailed": "Save failed",
      "llm.title": "LLM",
      "llm.backend": "Backend",
      ...
      "emotion.disabled": "Recognition off",
      "emotionLabel.disabled": "Emotion off",
    },
    ...
    zh: {
      ...
      // ── Details tab ──
      "speechProvider.title": "语音模型模式",
      "speechProvider.mode": "模式",
      "speechProvider.local": "本地模式",
      "speechProvider.online": "线上千问",
      "speechProvider.apiKey": "DashScope API Key",
      "speechProvider.url": "千问 Realtime 地址",
      "speechProvider.model": "Realtime 模型",
      "speechProvider.voice": "音色",
      "speechProvider.compatUrl": "视觉 API 地址",
      "speechProvider.visionModel": "视觉模型",
      "speechProvider.apply": "保存语音模式",
      "speechProvider.current": "当前：{mode}",
      "speechProvider.keySaved": "API Key 已保存",
      "speechProvider.keyMissing": "API Key 未保存",
      "speechProvider.restartRequired": "需重启语音服务生效",
      "speechProvider.saved": "语音模式已保存",
      "speechProvider.loadFailed": "读取语音模式失败",
      "speechProvider.saveFailed": "保存失败",
      "llm.title": "大模型",
      "llm.backend": "后端",
      ...
      "emotion.disabled": "识别已关闭",
      "emotionLabel.disabled": "表情识别关闭",
    },
  };
